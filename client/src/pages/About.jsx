...
// This is the production version of the About page

function About() {
  return (
    <div>
      <h1>About</h1>
      <p>Welcome to PastPaperGen!</p>
      <p>This website is designed to help you generate past papers for your exams by giving <b>YOU</b> the power to create your own past papers.</p>
